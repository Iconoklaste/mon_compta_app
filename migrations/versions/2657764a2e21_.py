...
Revision ID: 2657764a2e21
Revises: 
Create Date: 2025-04-13 18:20:05.695892
...
def upgrade():
    ...
    sa.Column('solde_initial', sa.Float(), nullable=False),
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('montant_debit', sa.Float(), nullable=True),
    sa.Column('montant_credit', sa.Float(), nullable=True),
